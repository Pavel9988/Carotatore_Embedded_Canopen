...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1017_producerHeartbeatTime = 1000,            /* Heart-beat for 1000 ms */
    .x1018_identity = {
...
OD_ATTR_RAM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_1010_storeParameters = {
        .dataOrig0 = &OD_PERSIST_COMM.x1010_storeParameters_sub0,
        .dataOrig = &OD_PERSIST_COMM.x1010_storeParameters[0],
    ...
    .o_1011_restoreDefaultParameters = {
        .dataOrig0 = &OD_PERSIST_COMM.x1011_restoreDefaultParameters_sub0,
        .dataOrig = &OD_PERSIST_COMM.x1011_restoreDefaultParameters[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    ...
    .o_1200_SDOServerParameter = {
        ...
        {
            .dataOrig = &OD_PERSIST_COMM.x1200_SDOServerParameter.COB_IDClientToServerRx,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x1200_SDOServerParameter.COB_IDServerToClientTx,
            .subIndex = 2,
            .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
            .dataLength = 4
        }
